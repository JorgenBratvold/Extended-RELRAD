...
if __name__ == "__main__":
    ...
    run_and_plot_contingency(Case_Study_I_system, line_id=contingency_id, Vmin=0.95, cap_limit=0.2, plot=True)
    ...
    run_and_plot_contingency(Case_Study_II_system, line_id=contingency_id, Vmin=0.95, cap_limit=0.35, plot=True)

    # Case Study III: V095-Cap1-RC62-BESS
    ...
    run_and_plot_contingency(Case_Study_III_system, line_id=contingency_id, Vmin=0.95, cap_limit=0.1, plot=True, BESS_buses=BESS_121, enable_bess_islanding=False)

    # Case Study IV: V095-Cap2-All and Case Study IV: V095-Cap2-All-BESS
    ...
    run_and_plot_contingency(Case_Study_IV_system, line_id=contingency_id, Vmin=0.95, cap_limit=0.20, plot=True, BESS_buses=BESS_all, enable_bess_islanding=False)
    run_and_plot_contingency(Case_Study_IV_system, line_id=contingency_id, Vmin=0.95, cap_limit=0.30, plot=True, BESS_buses=BESS_all, enable_bess_islanding=False)

    # Case Study V: V095-Cap1-RC62-BESS-island
    ...
    run_and_plot_contingency(Case_Study_V_system, line_id=contingency_id, Vmin=0.95, cap_limit=0.1, plot=True, BESS_buses=BESS_all, enable_bess_islanding=True)

    from Extended_RELRAD.case_studies.RBTS_Bus_2_case_studies.Bus_2_Case_A import Bus_2_Case_A_system
    run_and_plot_contingency(Bus_2_Case_A_system, line_id=1, Vmin = 0.0, cap_limit=0.2, plot=True)

    from Extended_RELRAD.case_studies.RBTS_Bus_2_case_studies.Bus_2_Case_D import Bus_2_Case_D_system 
    run_and_plot_contingency(Bus_2_Case_D_system, line_id=10, Vmin = 0.9, cap_limit=1000, plot=True)
    ...
    run_and_plot_contingency(IEEE_123_Bus_system, line_id=40, Vmin=0.80, cap_limit=3.5, plot=True)

    # RBTS Bus 4 case A 
    from Extended_RELRAD.case_studies.RBTS_Bus_4_case_studies.Bus_4_Case_A import Bus_4_Case_A_system
    run_and_plot_contingency(Bus_4_Case_A_system, line_id=1, Vmin = None, cap_limit=1000, plot=True)
