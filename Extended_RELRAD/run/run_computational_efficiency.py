...
def benchmark_case(system, cases, repeats=5, plot=False, objective="load_shed"):
    times = []
    for _ in range(repeats):
        start = time.perf_counter()
        _, _ = run_case_study(system=system, cases=cases, plot=plot, objective=objective)
...
if __name__ == "__main__":
    ...
    out = benchmark_case(Case_Study_I_system, CINELDI_single_RC_case, repeats=5, plot=False, objective="cost")
    ...
    out = benchmark_case(Case_Study_II_system, CINELDI_multi_RC_case, repeats=5, plot=False, objective="cost")
    ...
    out = benchmark_case(Bus_2_Case_A_system, RBTS_Bus_2_case_A_case, repeats=5, plot=False, objective="load_shed")
    ...
    out = benchmark_case(Bus_2_Case_D_system, RBTS_Bus_2_case_D_case, repeats=5, plot=False, objective="load_shed")
